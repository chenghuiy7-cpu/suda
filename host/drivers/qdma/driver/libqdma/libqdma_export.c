...
EXPORT_SYMBOL(qdma_queue_get_config);
...
EXPORT_SYMBOL(qdma_device_capabilities_info);
...
EXPORT_SYMBOL(qdma_config_reg_info_dump);
...
EXPORT_SYMBOL(qdma_config_reg_dump);
...
EXPORT_SYMBOL(qdma_queue_dump_desc);
...
EXPORT_SYMBOL(qdma_queue_dump_cmpt);
...
EXPORT_SYMBOL(qdma_queue_remove);
...
EXPORT_SYMBOL(qdma_queue_config);
...
EXPORT_SYMBOL(qdma_queue_start);
...
EXPORT_SYMBOL(qdma_get_queue_state);
...
EXPORT_SYMBOL(qdma_get_queue_count);
/*****************************************************************************/
/**
...
EXPORT_SYMBOL(qdma_intr_ring_dump);
...
EXPORT_SYMBOL(qdma_software_version_info);
...
EXPORT_SYMBOL(qdma_request_submit);

/*****************************************************************************/
/**
 * qdma_queue_get_irq_affinity() - Get the interrupt CPU afffinity of the queue
 *
 * @param[in]	dev_hndl:	dev_hndl returned from qdma_device_open()
 * @param[in]	id:		queue index
 *
 * @return	cpumask of the associated queue
 *****************************************************************************/
const struct cpumask *qdma_queue_get_irq_affinity(unsigned long dev_hndl, unsigned long id)
{
	struct qdma_descq *descq;
	struct xlnx_dma_dev *xdev = (struct xlnx_dma_dev *)dev_hndl;
	...
	return pci_irq_get_affinity(pdev, descq->intr_id);
}

EXPORT_SYMBOL(qdma_queue_get_irq_affinity);
...
EXPORT_SYMBOL(qdma_batch_request_submit);
