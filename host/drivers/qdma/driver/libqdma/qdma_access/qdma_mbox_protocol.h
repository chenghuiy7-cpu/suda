...
/*****************************************************************************/
/**
 * qdma_mbox_compose_pfch_tag_get(): compose message to get prefetch tag
 *
 * @func_id:   destination function id
 * @qid:   queue id for which the prefetch tag has to be read
 * @raw_data: output raw message to be sent
 *
 * Return:	0  : success and < 0: failure
 *****************************************************************************/
...
/*****************************************************************************/
/**
 * qdma_mbox_pfch_tag_get(): get csr info from received message
 *
 * @rcv_data: mbox message recieved
 * @csr: pointer to the csr info
 *
