...
/*****************************************************************************/
/**
 * Get C2H prefetch tag for a given queue
 *
 * @param dev_hndl	dev_hndl returned from qdma_device_open()
 * @param qid		queue id
 * @param tag		pointer to hold the prefetch tag
 *
 * @returns		0 for success and <0 for error
 * gets C2H prefetch tag for a given queue
 *
 *****************************************************************************/
int qdma_get_pfch_tag(unsigned long dev_hndl, uint16_t qid, uint16_t *tag);
