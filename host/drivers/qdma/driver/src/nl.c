					...
					struct qdma_queue_conf *qconf)
{
	...
	pr_debug("wb_status_en is %u", qconf->wb_status_en);
	...
	if (xnl_chk_attr(XNL_ATTR_PORT_ID, info,
			qconf->qidx, NULL, 0) == 0)
		qconf->port_id =
			nla_get_u32(info->attrs[XNL_ATTR_PORT_ID]);
