...
SDK_TOOL_PATH := $(VIVADO_TOOL_BASE_SW)/Vitis/$(VIVADO_VERSION_SW)/bin

# Cross-compiler location
COMPILER_BASE := $(VIVADO_TOOL_BASE_SW)/Vitis/$(VIVADO_VERSION_SW)/gnu
#=================================================
